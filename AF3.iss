...
#define MyAppName "AF3 X2 Driver"
...
AppId={{03D90E18-8FC8-48A8-BCCE-80504174F902}
AppName={#MyAppName}
...
OutputBaseFilename=AF3_X2_Installer
...
Source: "focuserlist deepskydadAF3.txt";                DestDir: "{app}\Miscellaneous Files"; Flags: ignoreversion
Source: "focuserlist deepskydadAF3.txt";                DestDir: "{app}\Miscellaneous Files"; DestName: "focuserlist64 deepskydadAF3.txt"; Flags: ignoreversion
; 32 bits
Source: "libaf3\Win32\Release\libaf3.dll";              DestDir: "{app}\Plugins\FocuserPlugins"; Flags: ignoreversion
Source: "af3.ui";                                       DestDir: "{app}\Plugins\FocuserPlugins"; Flags: ignoreversion
; 64 bits
Source: "libaf3\x64\Release\libaf3.dll";                DestDir: "{app}\Plugins64\FocuserPlugins"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\FocuserPlugins'))
Source: "af3.ui";                                       DestDir: "{app}\Plugins64\FocuserPlugins"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\FocuserPlugins'))

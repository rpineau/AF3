...
PACKAGE_NAME="AF3_X2.pkg"
BUNDLE_NAME="org.rti-zone.AF3X2"

if [ ! -z "$app_id_signature" ]; then
    codesign -f -s "$app_id_signature" --verbose ../build/Release/libaf3.dylib
fi

mkdir -p ROOT/tmp/AF3_X2/
cp "../af3.ui" ROOT/tmp/AF3_X2/
cp "../focuserlist deepskydadAF3.txt" ROOT/tmp/AF3_X2/
cp "../build/Release/libaf3.dylib" ROOT/tmp/AF3_X2/
